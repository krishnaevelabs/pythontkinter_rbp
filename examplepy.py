...
class GetPort_SerialData:
    ...
    def readcsv():
        ...
        with open('/home/pi/Desktop/pytkinter_prod/carecalldata.csv', 'rt')as f:
            data = csv.reader(f)
            for row in data:
